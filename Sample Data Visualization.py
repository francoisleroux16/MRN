...
# plt.scatter(zvals,yvals) #shows where the pressure measurements were made
...
def plot_diffs(index,Final_Data):
    ...
    fig = plt.figure('P2P3')
    sns.distplot(Pdiff2, kde=False, label='P2 Values')
    sns.distplot(Pdiff3, kde = False, label='P3 Values')
    ...
    fig = plt.figure('P4P5')
    sns.distplot(Pdiff4, kde=False, label='P4 Values')
    sns.distplot(Pdiff5, kde = False, label='P5 Values')
    plt.title("Distribution of the changes between the original and spatially corrected data")
    plt.xlabel("Value Difference")
    plt.ylabel("Frequency")
    plt.legend()
    ...
    fig = plt.figure('Pavg')
    sns.distplot(Pavg, kde=False, label=r'$\bar P$ Values')
    plt.title("Distribution of the changes between the original and spatially corrected data")
    plt.xlabel("Value Difference")
    plt.ylabel("Frequency")
    plt.legend()
